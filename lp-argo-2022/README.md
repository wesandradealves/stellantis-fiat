...
| :--- | :---: | :---: | :---: |:---: | :---: |
| [lp-argo-2022][branch-main] | [Repositório][client-repo] | [Link][client-url-prod] | [Link][client-url-nonprod] | 2022 | [![Project Status][project-status-active]][client-url-prod] |
