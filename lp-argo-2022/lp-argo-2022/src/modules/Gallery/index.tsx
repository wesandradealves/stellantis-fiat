  ...
  return (
    <>
      <div id="galeria" className="root">
        ...
        >
          <h2 className={`desktop desktop-mobile ${styles.title}`}>
            Tudo o que você já gostou por outros ângulos!
          </h2>
          <h2 className={`mobile ${styles.title}`}>Por todos os ângulos</h2>
...
const ThumbDesktop = ({item, onClick, bulletActive}: ThumbDesktopProps) => (
  ...
  >
    <Image
      src={`/assets/images/gallery/cover-gallery-${item.idx}.png`}
      alt=""
    />
  </div>
);
