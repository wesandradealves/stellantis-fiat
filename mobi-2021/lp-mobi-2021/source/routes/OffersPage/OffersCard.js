...
export function OffersCard({ className, classes, data: info, ...props }) {
  ...
  const mountImageSrc = (info) => {
    ...
    }//ofertas.fiat.com.br/content/dam/fiat/products`;
    ...
    <div className={cls(classes.root, className)}>
      <header className={cls(classes.header)}>
        ...
        <div className={cls(classes.headerCar)}>
          <img
            className={cls(classes.headerCarImage)}
            alt="ofertas"
            src={mountImageSrc(data.model)}
          />
        </div>
        <p
      ...
      <article className={cls(classes.feature)}>
      ...
      <footer className={cls(classes.part)}>
        ...
        <DataLayer
          onEvent={"OffersCard_ClicouEuQuero"}
          args={[data.id, info.model.mvsCode]}
        >
          <a
