...
export const Base = ({ name, mobile, data: info, ...props }) => {
	...
	useLayoutEffect(() => {
		...
		// serem exibidos no cliente com os nomes "vendáveis" e.g: mobi-tecnologico.
		const translations = {
			'mobi': '',
			'mobi-tecnologico': 'pai-nerd',
			'mobi-arrojado': 'bon-vivant',
			'mobi-moderno': 'mulher-design',
			'mobi-esportivo': 'amante-de-carro',
		};
	...
	return (
		<React.Fragment>
			<div data-ui-app={true}>
				<ScrollProgress color={'#ff8094'} height={2} />
