...
[client-url-prod]: https://fastback.fiat.com.br/
[client-url-nonprod]: https://fiat-lp-master-fiatfastback.commercial-nonprod.fcalatam.com.br
...
| :------------------------------ | :------------------------: | :---------------------: | :------------------------: | :--: | :---------------------------------------------------------: |
| [lp-fastback-2022][branch-main] | [Repositório][client-repo] | [Link][client-url-prod] | [Link][client-url-nonprod] | 2022 | [![Project Status][project-status-active]][client-url-prod] |
...
Utilizando o slug **lp-fastback-2022** a URL completa para as branches existentes ficariam desta maneira:

- lp-fastback-2022.dev.dcode.works
- lp-fastback-2022.hom.dcode.works
- lp-fastback-2022.new-feature.dcode.works

```json
"slug":"lp-fastback-2022"
```

#### External-access

As credenciais para acesso externo _são opcionais_ e são usadas para usuários que não tenham a [autenticação da Dentsu](https://myapps.dentsu.com/home/oidc_client/0oa6sxh2pwhyv1TOB0i7/aln2ysuixJR74D7Lc0g6) possam acessar o projeto.
